...
<template>
    ...
    <div class="w-full pb-5">
        <Link :href="route('skill.create')" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
        Add Skill
        </Link>
    </div>
                    ...
                    <tbody>
                        <tr v-for="skill in skills" :key="skill.id" class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                            ...
                            <td class="px-6 py-4">
                              ...
                              <td class="px-6 py-4">
                                <Link :href="route('skill.delete', skill.id)" method="delete" as="button" type="button" 
